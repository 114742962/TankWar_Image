...
public class Missile {
    ...
    /** 炮弹图片像素高度 */
    public static final int MISSILE_HEIGHT = 12;
    /** 炮弹图片像素高度 */
    public static final int REC_WIDTH = 8;
    /** 炮弹图片像素高度 */
    public static final int REC_HEIGHT = 8;
    /** 炮弹移动速度 */
    ...
    static {
        try {
            images.put("up", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileU.gif")));
            images.put("down", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileD.gif")));
            images.put("left", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileL.gif")));
            images.put("right", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileR.gif")));
            images.put("upleft", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileLU.gif")));
            images.put("upright", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileRU.gif")));
            images.put("downleft", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileLD.gif")));
            images.put("downright", ImageIO.read(Explode.class.getClassLoader().getResource("images/missileRD.gif")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    * @throws
    ...
    public Rectangle getRectOfMissle() {
        return new Rectangle(x, y, REC_WIDTH, REC_HEIGHT);
    }
}
