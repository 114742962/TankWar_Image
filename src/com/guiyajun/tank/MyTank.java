...
public class MyTank extends Tank {
    ...
    static {
        try {
            images.put("up", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankU.gif")));
            images.put("down", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankD.gif")));
            images.put("left", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankL.gif")));
            images.put("right", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankR.gif")));
            images.put("upleft", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankLU.gif")));
            images.put("upright", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankRU.gif")));
            images.put("downleft", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankLD.gif")));
            images.put("downright", ImageIO.read(Explode.class.getClassLoader().getResource("images/mytankRD.gif")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
