...
public class Tank {
    ...
    /** 坦克碰撞判断像素宽度 */
    public static final int REC_WIDTH = 34;
    /** 坦克碰撞判断像素高度 */
    public static final int REC_HEIGHT = 34;
    /** 坦克移动速度 */
    ...
    * @throws
    ...
    public Missile fire(Color color, Direction dirOfBarrel) {
        ...
        switch(dirOfBarrel) {   
            ...
            case LEFT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, 
                    y + TANK_HEIGHT/2 - Missile.REC_HEIGHT/2 - 2, dirOfBarrel, this.twc, color);
                break;
            case RIGHT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, 
                    y + TANK_HEIGHT/2 - Missile.REC_HEIGHT/2 - 1, dirOfBarrel, this.twc, color);
                break;
            case UP_LEFT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, y + TANK_HEIGHT/2 - Missile.MISSILE_HEIGHT / 2, 
                    dirOfBarrel, this.twc, color);
                break;
            case UP_RIGHT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, y + TANK_HEIGHT/2 - Missile.MISSILE_HEIGHT / 2, 
                    dirOfBarrel, this.twc, color);
                break;
            case DOWN_LEFT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, y + TANK_HEIGHT/2- Missile
                    .MISSILE_HEIGHT/2,dirOfBarrel, this.twc, color);
                break;
            case DOWN_RIGHT:
                missileOfMyTank = new Missile(x + TANK_WIDTH/2 - Missile.MISSILE_WIDTH/2, y + TANK_HEIGHT/2 - Missile.MISSILE_HEIGHT / 2, dirOfBarrel, this.twc, color);
                break;
            default:
                break;
        }
