    ...
    * @throws
    ...
    public void lauchFrame() {
        ...
        try {
            ...
            tankProductionQuantity = Integer.parseInt(properties.getProperty("tankProductionQuantity"));
    ...
    public void paint(Graphics g) {
        ...
        if(enemyTanks.size() <= 0) {
            ...
            for(int j=0; j<tankProductionQuantity; j++) {
                enemyTanks.add(new EnemyTank(250, 80 + (50 * j), false, this));
            }
        }
